...
class FetchCharacterListUseCase @Inject constructor(
    private val characterRepository: CharacterRepository
) : BaseUseCase<Int, Flow<List<com.synchz.rick_morty.domain.entities.Character>>> {

    override suspend operator fun invoke(params: Int) = characterRepository.fetchCharactersFromServer(params)
}
